...
packages:
	@go get -u github.com/jurgen-kluft/esp32-controller
	@go get -u github.com/jurgen-kluft/esp32-transpiler
	@go install -u github.com/jurgen-kluft/esp32-transpiler
	@rm -rf $(INO_SDK_PATH)
